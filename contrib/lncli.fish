...
function __fish_has_entered_help --description "Test if the help subcommand has been given"
    for i in (commandline -opc)
...
complete -c lncli -f -a "$commands" -n '__fish_has_entered_help'
